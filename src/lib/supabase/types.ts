...
export type Database = {
  ...
  public: {
    Tables: {
      ...
      profiles: {
        Row: {
          approval_status: Database["public"]["Enums"]["staff_approval_status"]
          created_at: string
          dob: string | null
      ...
      signup_requests: {
        ...
        Relationships: [
          ...
          {
            foreignKeyName: "signup_requests_profile_id_fkey"
            columns: ["profile_id"]
            isOneToOne: false
            referencedRelation: "profiles"
            referencedColumns: ["id"]
    ...
    Functions: {
      ...
      check_inactivity_and_alert: { Args: never; Returns: undefined }
      clock_in: {
    ...
    Enums: {
      ...
      staff_approval_status: "pending" | "approved"
